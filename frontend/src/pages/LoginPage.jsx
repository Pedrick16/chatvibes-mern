        ...
        <div className="__login-form-container">
            <div className="__login-form">
                ...
                <div className="__login-section">
                    <form onSubmit={(e) => loginUser(e)}>
                        <div className=" mb-3">
                            ...
                            <input type="email" name="email" onChange={(e) => setData({...data, email:e.target.value })} className='form-control' placeholder='Enter your Email' />
                        </div>
                        <div className=" mb-3">
                            <label htmlFor="" className='mb-1'>password</label>
                            <input type="password" name="password" onChange={(e) => setData({...data, password:e.target.value})} className='form-control' placeholder='Enter your Password'/>
                ...
                <div className="__login-footer pt-2">
                    ...
                    <Link to='/register'><button type='submit' className='__btn btn btn-success'>Create  Account</button></Link>
                </div>
